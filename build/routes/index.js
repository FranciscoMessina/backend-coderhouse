...
router.post('/login', passport_1.default.authenticate('local', { session: true }), controllers_1.AuthController.login);
...
router.get('/api/random', (req, res) => {
    ...
    const forked = (0, node_child_process_1.fork)(node_path_1.default.join(__dirname, './random.js'));
