...
log4js_1.default.configure({
    appenders: {
        ...
        myWarningLogger: { type: 'file', filename: path_1.default.join(__dirname, '../logs/warnings.log') },
        myErrorLogger: { type: 'file', filename: path_1.default.join(__dirname, '../logs/error.log') },
    },
    categories: {
